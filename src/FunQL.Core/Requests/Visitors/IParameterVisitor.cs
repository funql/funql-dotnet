...
/// <summary>Visitor for the <see cref="Parameter"/> nodes.</summary>
/// <typeparam name="TState">Type of the <see cref="IVisitorState"/> for this visitor.</typeparam>
public interface IParameterVisitor<in TState> : IVisitor<TState> where TState : IVisitorState
{
    ...
    public Task Visit(Parameter node, TState state, CancellationToken cancellationToken);
}