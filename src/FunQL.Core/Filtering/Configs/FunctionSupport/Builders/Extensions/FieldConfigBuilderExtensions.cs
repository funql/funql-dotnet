...
public static class FieldConfigBuilderExtensions
{
    ...
    /// </returns>
    public static IFilterFunctionSupportConfigBuilder FilterSupport(this IFieldConfigBuilder builder) =>
        new FilterFunctionSupportConfigBuilder(builder.MutableConfig.TypeConfig.GetOrAddFilterSupportConfigExtension());
    ...
    public static IFieldConfigBuilder SupportsFilter(
