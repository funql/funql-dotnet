...
/// <summary>
/// The 'less than' (lt) expression filters data to only include items where <paramref name="FieldArgument"/> is less
/// than <paramref name="Constant"/>.
/// </summary>
...
) : BooleanExpression(FunctionName, Metadata)
{
    ...
    public const string FunctionName = "lt";
}