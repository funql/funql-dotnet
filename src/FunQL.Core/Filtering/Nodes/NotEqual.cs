...
/// <summary>
/// The 'not equal' (neq) expression filters data to only include items where <paramref name="FieldArgument"/> is not
/// equal to <paramref name="Constant"/>.
/// </summary>
...
) : BooleanExpression(FunctionName, Metadata)
{
    ...
    public const string FunctionName = "neq";
}