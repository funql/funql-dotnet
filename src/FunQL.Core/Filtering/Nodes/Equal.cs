...
/// <summary>
/// The 'equal' (eq) expression filters data to only include items where <paramref name="FieldArgument"/> is equal to
/// <paramref name="Constant"/>.
/// </summary>
...
) : BooleanExpression(FunctionName, Metadata)
{
    ...
    public const string FunctionName = "eq";
}