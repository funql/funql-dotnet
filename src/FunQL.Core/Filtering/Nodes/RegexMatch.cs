...
/// <summary>
/// The 'regex match' (reg) expression filters data to only include items where the <paramref name="FieldArgument"/>
/// string value matches the specified regular expression defined by the <paramref name="Constant"/>.
/// </summary>
/// <param name="FieldArgument">The field whose value is being evaluated.</param>
/// <param name="Constant">Regular expression that <paramref name="FieldArgument"/> should match.</param>
