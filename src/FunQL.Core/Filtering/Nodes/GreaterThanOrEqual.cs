...
/// <summary>
/// The 'greater than or equal' (gte) expression filters data to only include items where
/// <paramref name="FieldArgument"/> is greater than or equal to <paramref name="Constant"/>.
/// </summary>
...
public sealed record GreaterThanOrEqual(
...
) : BooleanExpression(FunctionName, Metadata)
{
    ...
    public const string FunctionName = "gte";
}