...
public static class TypeConfigBuilderExtensions
{
    ...
    /// </returns>
    public static ISortFunctionSupportConfigBuilder SortSupport(this ITypeConfigBuilder builder) =>
        new SortFunctionSupportConfigBuilder(builder.MutableConfig.GetOrAddSortSupportConfigExtension());
    ...
    public static ITypeConfigBuilder SupportsSort(
